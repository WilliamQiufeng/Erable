...
bool RuleSymbol::matchesStart(Erable::Compiler::Data::DataList list) {
	return false;
}

bool RuleSymbol::matchesAll(Erable::Compiler::Data::DataList list) {
	return false;
}

bool RuleSymbol::finished(Erable::Compiler::Data::DataList list, Erable::Compiler::Parser *parent) {
	return false;
}
...
bool TokenSymbol::matchesStart(Erable::Compiler::Data::DataList list) {
	return (not list.empty()) and isValidToken(list[0]);
}

bool TokenSymbol::matchesAll(Erable::Compiler::Data::DataList list) {
	return list.size() == 1 and matchesStart(list);
}

bool TokenSymbol::finished(Erable::Compiler::Data::DataList list, Parser *parent) {
...
bool Symbol::matchesStart(Erable::Compiler::Data::DataList) {
	return false;
}

bool Symbol::matchesAll(Erable::Compiler::Data::DataList) {
	return false;
}

bool Symbol::finished(Erable::Compiler::Data::DataList, Erable::Compiler::Parser *parent) {
	return false;
}
