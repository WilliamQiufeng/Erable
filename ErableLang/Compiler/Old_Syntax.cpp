...
void Erable::Compiler::Syntax::initSyntaxes() {
	...
	auto list = "list"_Rule - (
			"op"_RuleSymbol
			| ("list"_RuleSymbol + "COMMA"_TokenSymbol + "op"_RuleSymbol)
	);
	...
	auto &&var = "var"_Rule - (
			...
			+ "COLON"_TokenSymbol + ("typeName"_RuleSymbol << "type")
			+ "SET"_TokenSymbol
			+ ("op"_RuleSymbol << "value")
	);
	auto &&binaryOp = "binaryOp"_Rule - (
			("op"_RuleSymbol + ("ADD"_TokenSymbol | "SUB"_TokenSymbol) + "op"_RuleSymbol)
			| ("op"_RuleSymbol + ("MUL"_TokenSymbol | "DIV"_TokenSymbol | "MOD"_TokenSymbol) + "op"_RuleSymbol)
			| ("op"_RuleSymbol +
			   ("LEFT_SHIFT"_TokenSymbol | "RIGHT_SHIFT"_TokenSymbol | "UNSIGNED_RIGHT_SHIFT"_TokenSymbol) +
			   "op"_RuleSymbol)
			| ("op"_RuleSymbol + ("BIT_AND"_TokenSymbol | "BIT_OR"_TokenSymbol) + "op"_RuleSymbol)
			| ("op"_RuleSymbol + ("AND"_TokenSymbol | "OR"_TokenSymbol) + "op"_RuleSymbol)
	);
	...
	auto &&bracket = "bracket"_Rule - (
			"LEFT_PAREN"_TokenSymbol + "op"_RuleSymbol + "RIGHT_PAREN"_TokenSymbol
	);
	...
	auto &&ifstmt = "ifstmt"_Rule - (
			("IF"_TokenSymbol + "LEFT_PAREN"_TokenSymbol + "op"_RuleSymbol + "RIGHT_PAREN"_TokenSymbol +
			 "op"_RuleSymbol)
			| "ifstmt"_RuleSymbol + "ELSE"_TokenSymbol + "op"_RuleSymbol
	);
	auto &&whilestmt = "whilestmt"_Rule - (
			("WHILE"_TokenSymbol + "LEFT_PAREN"_TokenSymbol + "op"_RuleSymbol + "RIGHT_PAREN"_TokenSymbol +
			 "op"_RuleSymbol)
	);
