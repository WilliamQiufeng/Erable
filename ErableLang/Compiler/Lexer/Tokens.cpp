...
//        }
		tokens = {
				new PlainTokenElement("IF", "if"),
				new PlainTokenElement("WHILE", "while"),
				new PlainTokenElement("LEFT_PAREN", "("),
				new PlainTokenElement("RIGHT_PAREN", ")"),
				new PlainTokenElement("LEFT_ARR", "["),
				new PlainTokenElement("RIGHT_ARR", "]"),
				new PlainTokenElement("START_SCOPE", "{"),
				new PlainTokenElement("END_SCOPE", "}"),
				new PlainTokenElement("COLON", ":"),
				new PlainTokenElement("SEMICOLON", ";"),
				new PlainTokenElement("DOT", "."),
				new PlainTokenElement("ACCESS", "::"),
				new PlainTokenElement("SET", "="),
				new PlainTokenElement("ADD", "+"),
				new PlainTokenElement("SUB", "-"),
				new PlainTokenElement("MUL", "*"),
				new PlainTokenElement("DIV", "/"),
				new PlainTokenElement("MOD", "%"),
				new PlainTokenElement("LESS_THAN", "<"),
				new PlainTokenElement("MORE_THAN", ">"),
				new PlainTokenElement("LESS_THAN_OR_EQUAL_TO", "<="),
				new PlainTokenElement("MORE_THAN_OR_EQUAL_TO", ">="),
				new PlainTokenElement("BIT_AND", "&"),
				new PlainTokenElement("BIT_OR", "|"),
				new PlainTokenElement("BIT_NOT", "~"),
				new PlainTokenElement("AND", "&&"),
				new PlainTokenElement("OR", "||"),
				new PlainTokenElement("NOT", "!"),
				new PlainTokenElement("REF", "@"),
				new PlainTokenElement("GET_REF", "#"),
				new PlainTokenElement("LEFT_SHIFT", "<<"),
				new PlainTokenElement("RIGHT_SHIFT", ">>"),
				new PlainTokenElement("UNSIGNED_RIGHT_SHIFT", ">>>"),
				new PlainTokenElement("COMMA", ","),
				new PlainTokenElement("VAR", "var"),
				new PlainTokenElement("CONST", "const"),
				new PlainTokenElement("FUNCTION", "function"),
				new PlainTokenElement("CLASS", "class"),
				new PlainTokenElement("STRUCT", "struct"),
				new PlainTokenElement("OCCUPIES", "occupies"),
				new PlainTokenElement("INTEGRAL", "integral"),
				new PlainTokenElement("ABSTRACT", "abstract"),
				new PlainTokenElement("TYPE", "type"),
				new PlainTokenElement("OVERRIDE", "override"),
				new PlainTokenElement("NEW", "new"),
				new PlainTokenElement("RETURN", "return"),
				new PlainTokenElement("CONTINUE", "continue"),
				new PlainTokenElement("BREAK", "break"),
//            tokens.push_back(new MultipleRegexTokenElement("HEX", {"0.*", "0x.*", "0x[0-9a-f]+"}));
//            tokens.push_back(new MultipleRegexTokenElement("BIN", {"0.*", "0b.*", "0b[01]+"}));
//            tokens.push_back(new MultipleRegexTokenElement("OCT", {"0.*", "0o.*", "0o[0-8]+"}));
//            tokens.push_back(new MultipleRegexTokenElement("DOUBLE", {"[0-9]+.*", "[0-9]+\\..*", "[0-9]+\\.[0-9]+"}));
				new NumberTokenElement(),
				new StringTokenElement(),
//            tokens.push_back(new MultipleRegexTokenElement("COMMENT", {"/.*", "//.*"}));
				new BlockCommentTokenElement(),
				new RegexTokenElement("NAME", "[a-zA-Z_$][a-zA-Z0-9_$]*"),
		};
	}
}
