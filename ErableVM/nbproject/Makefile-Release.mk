...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/erablevm

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/erablevm: ${OBJECTFILES}
...
${OBJECTDIR}/LibLoader.o: LibLoader.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LibLoader.o LibLoader.cpp
...
${OBJECTDIR}/NativeFunctions.o: NativeFunctions.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NativeFunctions.o NativeFunctions.cpp
...
${OBJECTDIR}/include/dynamicro.o: include/dynamicro.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/dynamicro.o include/dynamicro.cpp
...
${OBJECTDIR}/LibLoader_nomain.o: ${OBJECTDIR}/LibLoader.o LibLoader.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LibLoader_nomain.o LibLoader.cpp;\
	else  \
...
${OBJECTDIR}/NativeFunctions_nomain.o: ${OBJECTDIR}/NativeFunctions.o NativeFunctions.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NativeFunctions_nomain.o NativeFunctions.cpp;\
	else  \
...
${OBJECTDIR}/Types_nomain.o: ${OBJECTDIR}/Types.o Types.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Types_nomain.o Types.cpp;\
	else  \
...
${OBJECTDIR}/include/dynamicro_nomain.o: ${OBJECTDIR}/include/dynamicro.o include/dynamicro.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/dynamicro_nomain.o include/dynamicro.cpp;\
	else  \
